...
public:
    ...
    virtual unsigned short defaultPort() const = 0;
...
public:
    ...
    virtual unsigned short defaultPort() const { return 8333; }
...
public:
    ...
    virtual const Magic& magic() const { return _magic; };
    virtual unsigned short defaultPort() const { return 18333; }
...
public:
    ...
    virtual const Magic& magic() const { return _magic; };
    virtual unsigned short defaultPort() const { return 9333; }
...
public:
    DogecoinChain();
    virtual const int protocol_version() const { return 70003; } // 0.7.0.3
    virtual const Block& genesisBlock() const ;
    virtual const uint256& genesisHash() const { return _genesis; }
    virtual const int64_t subsidy(unsigned int height, uint256 prev = uint256(0)) const ;
    virtual bool isStandard(const Transaction& tx) const ;
    ...
    virtual const Magic& magic() const { return _magic; };
    virtual unsigned short defaultPort() const { return 22556; }
    
    virtual unsigned int ircChannels() const { return 1; } // number of groups to try (100 for bitcoin, 2 for litecoin)
    
private:
    const uint256 getPoWHash(const BlockHeader& block) const;
private:
    Block _genesisBlock;
    uint256 _genesis;
    Magic _magic;
...
class COINCHAIN_EXPORT DogetestChain : public Chain {
public:
    DogetestChain();
    virtual const int protocol_version() const { return 70002; } // 0.7.0.2
    virtual const Block& genesisBlock() const ;
    ...
    //    virtual char networkId() const { return 0x00; } // 0x00, 0x6f, 0x34 (bitcoin, testnet, namecoin)
    virtual ChainAddress getAddress(PubKeyHash hash) const { return ChainAddress(0x71, hash); }
    virtual ChainAddress getAddress(ScriptHash hash) const { return ChainAddress(0xc4, hash); }
    virtual ChainAddress getAddress(std::string str) const {
        ChainAddress addr(str);
        if(addr.version() == 0x71)
            addr.setType(ChainAddress::PUBKEYHASH);
        else if (addr.version() == 0xc4)
            addr.setType(ChainAddress::SCRIPTHASH);
        return addr;
    ...
    virtual const Magic& magic() const { return _magic; };
    virtual unsigned short defaultPort() const { return 44556; }
    
    virtual std::string ircChannel() const { return "dogecoinTEST3"; }
